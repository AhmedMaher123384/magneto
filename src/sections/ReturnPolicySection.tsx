...
import { ChevronDown, Package, Truck, CreditCard, Ban, RefreshCw } from 'lucide-react';
...
const ReturnPolicySection: React.FC = () => {
  ...
  const policyItems = [
    {
      ...
      content: "يمكن إرجاع المنتج خلال 7 أيام من تاريخ الاستلام إذا كان في حالته الأصلية وغير مستخدم. يجب أن يكون المنتج معبأ في عبوته الأصلية مع جميع الملحقات."
    },
    {
      title: "عملية الإرجاع",
      icon: <Truck size={22} />,
      content: "اتصل بخدمة العملاء للحصول على رقم إرجاع. أرسل المنتج إلينا خلال 7 أيام. سنقوم بفحص المنتج ومعالجة الإرجاع خلال 5 أيام عمل."
    },
    {
      title: "رسوم الإرجاع",
      icon: <CreditCard size={22} />,
      content: "رسوم الشحن للإرجاع تكون على حساب العميل إلا في حالة وجود عيب في المنتج. سنقوم برد المبلغ الكامل باستثناء رسوم الشحن الأصلية."
    },
    {
      title: "الاستثناءات",
      icon: <Ban size={22} />,
      content: "لا يمكن إرجاع المنتجات المستخدمة أو التالفة بسبب سوء الاستخدام. المنتجات الشخصية أو المخصصة غير قابلة للإرجاع."
    },
    {
      title: "رد المبالغ",
      icon: <RefreshCw size={22} />,
      content: "يتم رد المبلغ إلى طريقة الدفع الأصلية خلال 7-10 أيام عمل بعد استلام المنتج المرتجع وفحصه."
    }
  ];
  ...
  return (
    <section id="return-policy" className="py-24 bg-black overflow-hidden relative">
      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        ...
        >
          ...
          <p className="text-zinc-400 text-lg max-w-3xl mx-auto leading-relaxed">
            شفافية تامة، رضا مضمون، وثقة كاملة في كل خطوة.
          </p>
            ...
            {policyItems.map((item, index) => (
              ...
              >
                <button
                  ...
                  aria-controls={`return-content-${index}`}
                  className={`
                ...
                <AnimatePresence>
                  {openIndex === index && (
                    <motion.div
                      id={`return-content-${index}`}
                      role="region"
                      aria-labelledby={`return-title-${index}`}
